...
const DEMO_BUS_NO = 'JK-01-A-1234';
...
const violations = [
  ...
  { id: 'vio_2', busNo: DEMO_BUS_NO, driverName: 'Jehangir Dar', type: 'Overspeeding', detail: '58 km/h on Boulevard Road', date: '12 Jul 2026', severity: 'medium' },
...
module.exports = { DEMO_BUS_NO, fleet, rankings, compliance, violations };
