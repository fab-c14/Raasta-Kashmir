...
function safetyReport(trip) {
  ...
  return {
    ...
    headline:
      score >= 90 ? 'Excellent, consistently safe driving.' : score >= 80 ? 'Good trip with minor safety flags.' : 'Trip needs attention — repeated safety flags.',
    strengths,
    risks,
    recommendations,
  };
...
function complaintAnalysis(text) {
...
function weeklyInsights() {
  return [
    ...
    { title: 'Overspeeding clusters on Boulevard Road', detail: '70% of overspeed events occur between 7:40–7:55 AM.', trend: 'flat' },
...
module.exports = { safetyReport, tripSummary, complaintAnalysis, weeklyInsights };
